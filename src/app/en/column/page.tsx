...
export const metadata: Metadata = {
  title: 'Journal | Kamon Engraving Studio',
  description:
    'Notes on family crests, craft and the objects we make — readings and reflections from the studio.',
};

export default async function EnColumnPage() {
